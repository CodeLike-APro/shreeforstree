          ...
          >
            ...
            <div
              ...
              className={`openSearch h-[2vw] w-[2vw] flex items-center justify-center cursor-pointer transition-all duration-200 hover:scale-110 ${
                searchActive && searchQuery === "" ? "hidden" : ""
              }`}
            >
              <svg
                fill="currentColor"
            ...
            <div
              ...
              className={`closeSearch h-[2vw] w-[2vw] flex items-center justify-center cursor-pointer transition-all duration-200 hover:scale-110 mt-1 ${
                searchActive && searchQuery === "" ? "" : "hidden"
              }`}
            >
              <svg
